...
unset($__errorArgs, $__bag); ?>
    ...
    <form action="<?php echo e(route('tutorial.update', ['tutorial'=>$data->id])); ?>" method="POST" class="w-full flex flex-col items-center">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
            <div class="w-full my-2">
                <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tutorial title</label>
                <input value="<?php echo e(old('title', $data->title)); ?>" type="text" id="title" name="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5"  required />
            </div>
            <div class="w-full my-2">
                <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category</label>
                <input value="<?php echo e(old('category', $data->category->Category)); ?>" type="text" id="category" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5" required />
            </div>
            <div class="w-full my-2">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/tutorial/edit.blade.php ENDPATH**/ ?>