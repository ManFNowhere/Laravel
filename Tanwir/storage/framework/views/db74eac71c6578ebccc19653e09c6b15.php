<section class="bg-gray-900 rounded-lg p-6" id="accessibility-section">
    ...
    <article class="space-y-6">
        ...
        <p class="text-white">Now <a href="<?php echo e(route('color.contrast')); ?>" target="_blank" class="underline decoration-solid text-blue-400">open color-contrast page</a> to see how bad or good color contrast on text, and try to see it with build in Chrome function.</p>
...
<?php /**PATH /var/www/html/resources/views/tutorial/accessibility.blade.php ENDPATH**/ ?>