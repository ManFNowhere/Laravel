<div id="term-body" class="bg-gray-900 hidden">
    <div class="text-white p-20 bg-gray-800 w-3/4 mx-auto rounded mt-20 text-center">
        <div class="bg-gray-900 p-5 text-start">
        ...
        <button id="close" class="mx-auto bg-red-600 rounded p-2 my-5">Close</button>
    </div>
</div>